...
export default function SignIn() {
  ...
  const handleEmailSignIn = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await signIn(email, password, userType.toUpperCase() as 'BRAND' | 'INFLUENCER');
  ...
  const roleDescription = {
    influencer: "Sign in to showcase your content and connect with brands",
    brand: "Sign in to discover influencers and manage campaigns"
  };
      ...
      <form onSubmit={handleEmailSignIn} className="space-y-4">
        ...
        >
          {loading && userType === type ? (
            ...
            `Sign in as ${type === 'influencer' ? 'Influencer' : 'Brand'}`
          )}
        </Button>
      </form>
    ...
    <div className="container flex flex-col md:flex-row items-center justify-center min-h-screen py-12 bg-gradient-to-br from-background to-muted/30">
      <div className="w-full max-w-lg mb-10 md:mb-0 md:mr-8 text-center md:text-left">
        ...
        <p className="text-xl text-muted-foreground max-w-md">
          Connect with the perfect influencers and brands to grow your business.
        </p>
