...
export default function SignUp() {
  ...
  const roleDescription = {
    influencer: "Create an account as an influencer to showcase your content and connect with brands",
    brand: "Create an account as a brand to discover and collaborate with influencers"
  };

  const renderSignUpForm = (type: 'influencer' | 'brand') => (
    <>
      <div className="mb-2">
  ...
  return (
    <div className="container flex flex-col md:flex-row items-center justify-center min-h-screen py-12 bg-gradient-to-br from-background to-muted/30">
      <div className="w-full max-w-lg mb-10 md:mb-0 md:mr-8 text-center md:text-left">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">Join our community</h1>
        <p className="text-xl text-muted-foreground max-w-md">
          Create an account to connect with the perfect influencers and brands for your business.
        </p>
        ...
        <CardContent className="space-y-4">
          <Tabs value={userType} onValueChange={(value) => setUserType(value as 'influencer' | 'brand')} className="w-full">
            ...
            <TabsContent value="influencer" className="space-y-4 pt-4">
              {renderSignUpForm('influencer')}
            </TabsContent>
            <TabsContent value="brand" className="space-y-4 pt-4">
              {renderSignUpForm('brand')}
            </TabsContent>
          </Tabs>
          ...
          {error && (
            <div className="p-3 rounded-md bg-destructive/10 text-destructive text-sm mb-4 flex items-start">
